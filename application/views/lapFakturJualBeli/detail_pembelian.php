  ...
  <div class="box">
    <div class="box-header with-border">
      <h3 class="box-title">Detail Pembelian pada Faktur Nomor : <?= $no_faktur;?></h3>
       <a class="btn btn-success pull-right waves-effect m-r-20" href="<?= base_url().'transaksi/Pembelian/printTrxPembelian/'.$no_faktur?>" target="_blank">Print Faktur Pembelian
      </a>
    </div>
    <div class="box-body">
