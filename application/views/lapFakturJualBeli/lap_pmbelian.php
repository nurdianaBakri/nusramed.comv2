                     ...
                     <td> 
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                              <li><a  href="<?= base_url().'laporan/FakturJualBeli/detail_pembelian/'.$key['id_detail_obat']?>">Detail
                                </a> </li> 
                              <li><a  href="<?= base_url().'laporan/FakturJualBeli/printTrxPembelian/'.$key['id_detail_obat']?>" target="_blank">Print
                                </a></li>
                            </ul>
                      </div> 
                     </td> 
