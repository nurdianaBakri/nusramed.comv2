...
<section class="content">
    ...
    <div class="alert alert-success" role="alert">
        YAY!, fitur ini berfungsi untuk Stok Opaname Barang. Jika obat tidak muncul di tabel ini, silahkan klik tombol "cari obat" untuk mencarinya
    </div>
    <div class="box">
        <div class="box-header with-border">
            ...
            <button class="btn btn-success pull-right waves-effect m-r-20 button_tambah" onclick="window.open('<?= base_url()."data/StokOpname/printStokOpname" ?>')"> Print Form Stok Opname
            </button>
        </div>
        <div class="box-body">
