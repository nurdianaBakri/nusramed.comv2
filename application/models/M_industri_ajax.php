...
class M_industri_ajax extends CI_Model { 


	var $table = 'v_industri';
	var $column_order = array('kd_industri','nama','alamat','no_telp','email','deleted'); //set column field database for datatable orderable
	var $column_search = array('kd_industri','nama','alamat','no_telp','email'); //set column field database for datatable searchable 
