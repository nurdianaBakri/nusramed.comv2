...
class M_suplier_ajax extends CI_Model { 


	var $table = 'v_suplier';
	var $column_order = array('kd_suplier','nama','alamat','no_hp','provinsi', 'no_rek','deleted'); //set column field database for datatable orderable
	var $column_search = array('kd_suplier','nama','alamat','no_hp','provinsi', 'no_rek'); //set column field database for datatable searchable 
