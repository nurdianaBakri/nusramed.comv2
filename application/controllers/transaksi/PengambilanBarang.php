...
*/
        ...
        if (sizeof($data)>0) {
            ...
            /*$data = $this->M_trxPenjualan->get_tagihan_per_faktur($no_faktur); 
            echo $this->show_cart($data);*/
            echo "data_ada";
    ...
    public function show_cart($data=null)
    { 
        $output = '';
        $no = 0; 
                ...
                if ($items['jenis_cart']=='pengambilan') {
                    ...
                    $output .='
                        <tr>
                            ...
                            <td>'.'<input type="number" class="form-control qty"  name="qty[]" size="1" value="'.$items['qty'].'" > 

                            </td> 
        
                            <td>'.'<input type="number" class="form-control qty_verified" name="qty_verified[]" size="1" value="'.$items['qty'].'" ></td>
        ...
        if ($data!=null)
        {
            ...
            <tr style="font-weight: bold;"> 
                <td colspan="2">Total Sebelum Diskon <br>'.$data['total1'].'</td>
                <td colspan="2">Potongan <br>'.$data['jumlah_potongan'].'</td>
                <td colspan="2">Total Setelah Diskon <br>'.$data['total_setelah_potongan'].'</td>
                <td >PPN <br>'.$data['ppn2'].'</td>
                <td >B. Kirim <br>0</td>
                <td >Materai <br>0</td>
                <td colspan="2">Jmlh Tagihan <br>'.$data['total_tagihan'].'</td>
            </tr>';
        } 
      ...
      public function get_tagihan_per_faktur()
    {
        $data = $this->M_trxPenjualan->get_tagihan_per_faktur("68620040001");
        print_r($data);
    }
