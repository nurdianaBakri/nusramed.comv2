        ...
        function edit(kd_industri)
        {
            ...
            $.ajax({
                ...
                {  
                    ...
                    $('.modal-title').text('Update Industri'); // Set title to Bootstrap modal title
            ...
            $.ajax( {
                ...
                success: function( response ) { 
                    try{     
                        ...
                        var options = {
                            fileName: "Data Industri Obat PT. Nusara Raya Medika"
                        };
            ...
            $.ajax( {
                ...
                success: function( response ) { 
                    try{    
                        ...
                        $('.modal-title').text('Tambah Industri'); // Set Title to Bootstrap modal title 
                    }catch(e) {  
                        alert('Exception while request..');
                    }  
                }
